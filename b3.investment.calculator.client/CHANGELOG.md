...
- Create Angular project with ng: `ng new b3.investment.calculator.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`b3.investment.calculator.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `b3.investment.calculator.client.esproj`).
