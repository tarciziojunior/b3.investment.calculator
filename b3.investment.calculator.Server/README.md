...
Para tornar o código modular e extensível, o projeto implementa diversos padrões de design e práticas de boas práticas, incluindo:
...
- **FluentValidation para Validação de Entrada**: Para garantir a qualidade e a manutenção do código, utilizamos a biblioteca **FluentValidation** para validar os valores de entrada. Com essa biblioteca, as regras de validação de campos estão separadas das regras de negócios, facilitando a manutenção e a legibilidade do código.
...
## Uso
Após configurar o ambiente, inicie o servidor e o cliente para acessar a aplicação e calcular o retorno de investimento.
